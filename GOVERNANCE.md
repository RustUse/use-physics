...
RustUse/use-physics uses a single-canonical-repository model: many public entry points are possible, but release authority stays with the canonical GitHub repository.
