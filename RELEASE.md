...
9. Confirm the focused-crate dry-run order remains `use-motion`, `use-force`, `use-energy`, `use-power`, `use-pressure`, `use-density`, then `use-thermodynamics`.
