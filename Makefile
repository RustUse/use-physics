...
FOCUSED_CRATES := use-motion use-force use-energy use-work use-power use-fluid use-electricity use-magnetism use-pressure use-density use-gravity use-momentum use-particle use-thermodynamics
