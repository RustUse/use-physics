...
FOCUSED_CRATES := use-motion use-force use-energy use-power use-electricity use-pressure use-density use-gravity use-momentum use-particle use-thermodynamics
